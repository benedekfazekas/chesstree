...
[![CI](https://github.com/benedekfazekas/chesstree/actions/workflows/ci.yml/badge.svg)](https://github.com/benedekfazekas/chesstree/actions/workflows/ci.yml)
[![PyPI](https://img.shields.io/pypi/v/chesstree)](https://pypi.org/project/chesstree/)
...
As a taster how the `d3html` format looks and works see [here](https://github.com/benedekfazekas/chesstree/blob/main/chesstree-interactive-caro-kann-exc.gif).
